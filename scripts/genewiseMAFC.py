...
def enrichASE(args):
    ...
    # filter hits
    df2 = df2[df2['ave_read_depth'] >= args.minReads]
    df2 = df2[df2['snp_count'] >= args.minSnps]
    df2 = df2[df2['aveLog2fc'] >= args.minLog2FoldChange]
...
def main():
    ...
    parser.add_argument('-r', '--minReads', required=False, type=int, default=10, 
    ...
    parser.add_argument('-f', '--minLog2FoldChange', required=False, type=float, default=1, 
                        help="minimum average absolute log2 fold change")
